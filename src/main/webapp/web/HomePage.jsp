  ...
  <div class="col-sm-3">
    ...
    <img class="card-img-top" src="images/insert.JPG" alt="Insert here">
      <div class="card-body text-center">
        ...
        <p class="card-text text-center">To Add Laptop Details</p>
  ...
  <div class="col-sm-3">
    <div class="card">
      ...
      <div class="card-body text-center">
        ...
        <p class="card-text text-left">To Update Laptop Details</p>
  ...
  <div class="col-sm-3">
    ...
    <img class="card-img-top" src="images/delete.JPG" alt="Delete here here">
      <div class="card-body text-center">
        ...
        <p class="card-text text-left">To Delete a Laptop record</p>
  ...
  <div class="col-sm-3">
    ...
    <img class="card-img-top" src="images/display.JPG" alt="Display here">
      <div class="card-body text-center">
        ...
        <p class="card-text text-left">To Display All laptop Record </p>
